  ...
  return (
    <div>
      ...
      <div
        ...
        className="flex border-2 mb-2 active:border-black rounded-xl  w-full p-3 items-center justify-center"
      >
        <img
          className="h-12"
      ...
      <div className="flex border-2 mb-2 active:border-black rounded-xl  w-full p-3 items-center justify-center">
        <img
          className="h-12"
